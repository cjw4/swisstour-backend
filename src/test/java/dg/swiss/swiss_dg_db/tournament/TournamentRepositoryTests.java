...
public class TournamentRepositoryTests {
    ...
    void TournamentRepository_findTournamentsWithEventAndRoundsByPlayerId_ReturnTournaments() {
        ...
        Tournament tournament =
                Tournament.builder().division("MPO").place(1).player(player).event(event).build();
        ...
        List<Tournament> result =
                tournamentRepository.findTournamentsWithEventAndRoundsByPlayerId(
                        otherPlayer.getId());
